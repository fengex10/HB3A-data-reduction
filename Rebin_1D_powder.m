function [ X_new, Y_new, err_new ] = Rebin_1D_powder( X, Y, dX )
...
%%
X_new = zeros(length(X_list)-1,1);
Y_new = zeros(length(X_list)-1,1);
err_new = zeros(length(X_list)-1,1);
